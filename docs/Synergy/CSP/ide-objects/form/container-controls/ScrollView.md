...
| **Özellik** 	| **Açıklama** 	|
|---	|---	|
| Key 	| Nesne içine eklenecek ögenin değerinin tanımlandığı alandır. Girilen değerin nesne içindeki diğer ögelerden farklı olması gereklidir. 	|
| Href 	| Öge içinde link tanımlanmak istendiğinde kullanılan alandır. 	|
